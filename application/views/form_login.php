            ...
            <div class="login-wrapper login grid-12">
                <div class="login-content">
                    ...
                    <div class="login-content-right grid-8">
                        ...
                        <form method="POST" action="<?= base_url('auth/login'); ?>" class="login-content-right-main grid-12">
                        ...
                        <div class="login-content-right-bot grid-12">
                            <div class="login-bot-top grid-12">
                                <div class="line"></div>
                                <span>or</span>
                                <div class="line"></div>
                            </div>
                            <div class="login-bot-mid grid-12">
                                <a href="#" class="login-bot-mid-item">
                                    <img src="<?= base_url('assets/') ?>img/login/icon1.svg" alt="">
                                    <span>SSO</span>
                                </a>
                                <a href="#" class="login-bot-mid-item">
                                    <img src="<?= base_url('assets/') ?>img/login/icon2.svg" alt="">
                                    <span>Facebook</span>
                                </a>
                                <a href="#" class="login-bot-mid-item">
                                    <img src="<?= base_url('assets/') ?>img/login/icon3.svg" alt="">
                                    <span>Google</span>
                                </a>
                            </div>
                            <div class="login-bot-bot grid-12">
                                <span>
